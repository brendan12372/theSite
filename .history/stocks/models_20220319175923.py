...
class Stock(models.Model):
    ...
    logo_url=models.CharField(blank=True,null=True,default='' ,max_length=50)
    ...
    logo_url=models.CharField(blank=True,null=True, max_length=200)
    ...
    def getValue(self):
        ...
        try:
            self.dividendRate=S.info['dividendRate']*100
        else:
            self.dividendRate=None 
        ...
        self.dividendYield = S.info['dividendYield']*100
        self.earningsQuarterlyGrowth = S.info['earningsQuarterlyGrowth']*100
        self.ebitda = S.info['ebitda']
        try:
        ...
        try:
            self.enterpriseToRevenue = round(S.info['enterpriseToEbitda'],2)
        except :
        ...
        try:
            ...
            self.forwardPE=0
        self.yearReturn=S.yearReturn*100
        self.pegRatio=round(S.pegRatio,2)
        self.marketCap=S.marketCap
        self.fullTimeEmployees=S.fullTimeEmployees
        self.shortPercentOfFloat=S.shortPercentOfFloat*100
        try:
        ...
        try:
            self.freeCashflow=S.info['freeCashflow']
        except:
            self.freeCashflow=0
        self.operatingMargins=S.info['operatingMargins']*100
        try:
            self.totalRevenue=S.info['totalRevenue']
        except:
            self.totalRevenue=0
        try:
            self.recommendationMean=S.info['recommendationMean']
        except :
            self.recommendationMean=0
        self.news=S.news
        try:
            self.ebitdaMargins=round(S.info["ebitdaMargins"],2)*100
        except:
        ...
        try:
            self.earningsQuarterlyGrowth=round(S.info['earningsQuarterlyGrowth'],2)*100
        except:
        ...
        try:
            self.trailingAnnualDividendRate=S.trailingAnnualDividendRate*100
        except :
            self.fiftyTwoWeekHigh=self.myzero
        try:
            self.dividendRate=round(S.info["dividendRate"],3)*100
        except :
            self.dividendRate=0
        try:
        ...
        try:
            ...
            pass
        try:
            self.returnOnEquity = round(S.roe,2)*100
        except:
        ...
        try:
            ...
            self.insiders=None
        try:
            self.totalCashPerShare = round(S.tcps,2)
        except:
        ...
        try:
            self.profitMargins = round(S.profitMargins,2)*100
        except:
        ...
        try:
            self.grossMargins = round(S.grossMargins,2)*100
        except:
