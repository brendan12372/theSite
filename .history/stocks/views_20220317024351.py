...
def stocks_list2(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            subject = form.cleaned_data['sector']
            message = form.cleaned_data['sortBy']
            sender = form.cleaned_data['sortDirection']
            cc_myself = form.cleaned_data['cc_myself']
            print(form.sortBy.clean())
            context={
        "data": {},
        "pks":pks,
        "form":form
